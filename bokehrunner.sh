...
bokeh serve Diffraktion Zugversuch Querdehnung Rollercoaster Drehscheibe-Corioliskraft --port $BokehPort --host localhost:$BokehPort --allow-websocket-origin=$WebsocketOrigin
