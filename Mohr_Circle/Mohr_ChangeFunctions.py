...
def ChangeRotatingPlane_Forces():
    ...
    if Mvar.Neta>0:
        ...
        Mvar.NetaP_arrow_source.data = dict(xS=[(12.5-Mvar.Neta)*cos((pi/2)+glMohrP_Angle)],xE=[12.5*cos((pi/2)+glMohrP_Angle)], yS=[((12.5-Mvar.Neta)*sin((pi/2)+glMohrP_Angle))], yE=[0+(12.5*sin((pi/2)+glMohrP_Angle))],  lW = [2])
        Mvar.NetaN_arrow_source.data = dict(xS=[(12.5-Mvar.Neta)*sin(glMohrP_Angle)],xE=[12.5*sin(glMohrP_Angle)],               yS=[-(12.5-Mvar.Neta)*cos(glMohrP_Angle)],         yE=[-12.5*cos(glMohrP_Angle)],            lW = [2])      
    ...
    if Mvar.Nzetaeta>0:
        Mvar.Nzetaeta1_arrow_source.data = dict(xS=[9*cos(glMohrP_Angle)+((Mvar.Nzetaeta/2)*sin(glMohrP_Angle))],  xE=[9*cos(glMohrP_Angle)-((Mvar.Nzetaeta/2)*sin(glMohrP_Angle))],  yS=[(0+9*sin(glMohrP_Angle))-((Mvar.Nzetaeta/2)*cos(glMohrP_Angle))], yE=[(0+9*sin(glMohrP_Angle))+((Mvar.Nzetaeta/2)*cos(glMohrP_Angle))], lW = [2])
        Mvar.Nzetaeta2_arrow_source.data = dict(xS=[-9*sin(glMohrP_Angle)-((Mvar.Nzetaeta/2)*cos(glMohrP_Angle))], xE=[-9*sin(glMohrP_Angle)+((Mvar.Nzetaeta/2)*cos(glMohrP_Angle))], yS=[(0+9*cos(glMohrP_Angle))-((Mvar.Nzetaeta/2)*sin(glMohrP_Angle))], yE=[(0+9*cos(glMohrP_Angle))+((Mvar.Nzetaeta/2)*sin(glMohrP_Angle))], lW = [2])
        Mvar.Nzetaeta3_arrow_source.data = dict(xS=[-9*cos(glMohrP_Angle)-((Mvar.Nzetaeta/2)*sin(glMohrP_Angle))], xE=[-9*cos(glMohrP_Angle)+((Mvar.Nzetaeta/2)*sin(glMohrP_Angle))], yS=[(0-9*sin(glMohrP_Angle))+((Mvar.Nzetaeta/2)*cos(glMohrP_Angle))], yE=[(0-9*sin(glMohrP_Angle))-((Mvar.Nzetaeta/2)*cos(glMohrP_Angle))], lW = [2])
        Mvar.Nzetaeta4_arrow_source.data = dict(xS=[9*sin(glMohrP_Angle)+((Mvar.Nzetaeta/2)*cos(glMohrP_Angle))],  xE=[9*sin(glMohrP_Angle)-((Mvar.Nzetaeta/2)*cos(glMohrP_Angle))],  yS=[(0-9*cos(glMohrP_Angle))+((Mvar.Nzetaeta/2)*sin(glMohrP_Angle))], yE=[(0-9*cos(glMohrP_Angle))-((Mvar.Nzetaeta/2)*sin(glMohrP_Angle))], lW = [2])
