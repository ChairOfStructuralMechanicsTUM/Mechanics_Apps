...
class SRS_RectangularMass(SRS_DiscreteMass):
    def __init__ (self, mass, x, y, w, h):
        SRS_DiscreteMass.__init__(self,mass)
...
class SRS_CircularMass(SRS_DiscreteMass):
