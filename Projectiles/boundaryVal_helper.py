...
def draw_cannon(fig):
    ...
    scaling_cannon = 60
    scaling_cannon_x = scaling_cannon*(max_x-min_x)/fig_width
    scaling_cannon_y = scaling_cannon*(max_y-min_y)/fig_height
...
def draw_target_at(fig, x_target):
    ...
    scaling_target = 30
    scaling_target_x = scaling_target*(max_x-min_x)/fig_width
    scaling_target_y = scaling_target*(max_y-min_y)/fig_height
