...
# -> store ColumnDataSources to access them in other files
##########################################################

# vis_callbacks
ColumnDataSources.ds_input                        = ds_input
ColumnDataSources.ds_glyph_images                 = ds_glyph_images
ColumnDataSources.ds_glyph_beam                   = ds_glyph_beam
ColumnDataSources.ds_glyph_lineload               = ds_glyph_lineload
ColumnDataSources.ds_arrow_lineload               = ds_arrow_lineload
ColumnDataSources.ds_glyph_springsPointMomentTemp = ds_glyph_springsPointMomentTemp
ColumnDataSources.ds_input_selected               = ds_input_selected
ColumnDataSources.ds_active_button                = ds_active_button
ColumnDataSources.ds_element_count                = ds_element_count
ColumnDataSources.ds_chosen_node                  = ds_chosen_node
ColumnDataSources.ds_1st_chosen                   = ds_1st_chosen
ColumnDataSources.ds_element_info                 = ds_element_info
ColumnDataSources.ds_indep_elements               = ds_indep_elements
ColumnDataSources.ds_nodedep_elements             = ds_nodedep_elements
ColumnDataSources.cb_get_selected_                = cb_get_selected_
ColumnDataSources.cb_plot_tap_                    = cb_plot_tap_ 
ColumnDataSources.cb_plot_xy_                     = cb_plot_xy_
# vis_elementToPlot
ColumnDataSources.ds_images                       = ds_images
# vis_initalization
ColumnDataSources.ds_x_axis                       = ds_x_axis
ColumnDataSources.ds_y_axis                       = ds_y_axis
