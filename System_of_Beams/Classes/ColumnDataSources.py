...
class ColumnDataSources:
    ...
    def __init__(self):
        ...
        self.ds_glyph_images = ColumnDataSource(data=dict())

        # data source for beam glyphs plotted in the input plot
        self.ds_glyph_beam = ColumnDataSource(data=dict(x=[], y=[], width=[], angle=[], name_user=[]))

        # data source for line load patch glyphs of the input plot
        self.ds_glyph_lineload = ColumnDataSource(data=dict(patch_x=[], patch_y=[], glyph_x=[], glyph_y=[],
                                                       x=[], y=[], name_user=[]))
        # data source for line load arrows
        self.ds_arrow_lineload = ColumnDataSource(data=dict(xs=[], ys=[], name_user=[]))
        ...
        self.cb_plot_tap_ = CustomJS(args=dict(div=None, ds=None, activated=None, element_count=None,
        ...
        self.style = 'float:left;clear:left;font_size=10pt'
        self.cb_plot_xy_ = CustomJS(args=dict(div=None), code="""
            //JavaScript code:
        ...
        self.url = url
        self.ds_images = ColumnDataSource(dict(
        ...
        self.ds_x_axis = ColumnDataSource(dict(x=axis_line, y=axis_zero))
        self.ds_y_axis = ColumnDataSource(dict(x=axis_zero, y=axis_line))
