...
export namespace diffraction_Surface3d {
...
export interface diffraction_Surface3d extends diffraction_Surface3d.Attrs {}

export class diffraction_Surface3d extends HTMLBox {
  properties: diffraction_Surface3d.Props

  constructor(attrs?: Partial<diffraction_Surface3d.Attrs>) {
    super(attrs)
  }
  ...
  static __name__ = "diffraction_Surface3d"

  static init_diffraction_Surface3d(): void {
    ...
    this.define<diffraction_Surface3d.Props>({
      x:           [ p.String           ],
      y:           [ p.String           ],
      z:           [ p.String           ],
      color:       [ p.String           ],
