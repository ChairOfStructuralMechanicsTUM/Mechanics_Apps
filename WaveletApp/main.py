...
# INTERACTIVE WIDGETS #
#######################
T0_input = TextInput(value= '1', title="Input T0:", width=200)
T1_input = TextInput(value= '2', title="Input T1:", width=200)
Amp_input = TextInput(value= '1', title="Input Amplitude:", width=200)
User_Func = TextInput(value= '', title="Input Function f(t)", width=200)
...
def update(attr, old, new):
    ...
    Resolut=float(sympify(Resolution.value.replace(',','.')))  # Interval
