"""
Dispersion1DMassSpringChain App - shows some common concepts used in this project
...
fig_dispersion_mono.xaxis.axis_label = r"$$\mu$$"
...
ka_mono_button_label = Paragraph(text=r"$$\mu$$= " + str(np.round(ka_mono, decimals=2)), styles={'font-style': 'italic', 'font-size': '16px'})
ka_di_button_label = Paragraph(text=r"$$\mu$$= " + str(np.round(ka_di, decimals=2)), styles={'font-style': 'italic', 'font-size': '16px'})
...
def mono_ka_plus_button_callback():
    ...
    if ka_mono + 2*np.pi/mass_anzahl <= 3.1:            # Nur die zulässigen Punkte auswählen lassen
        ...
        ka_mono = np.pi
    ka_mono_button_label.text = r"$$\mu$$= " + str(np.round(ka_mono, decimals=2))    # Text aktualisieren mit neuem Wert
...
def mono_ka_minus_button_callback():
    ...
    if ka_mono - 2*np.pi/mass_anzahl >= -3.1:
        ...
        ka_mono = - np.pi
    ka_mono_button_label.text = r"$$\mu$$= " + str(np.round(ka_mono, decimals=2))
    update_plot()
    reset_time()
...
ka_source_mono_superpos = ColumnDataSource(data=dict(ka_1=[ka_mono_superpos1], ka_2=[ka_mono_superpos2],
                                                     ...
                                                     y_2=[dis_rel_mono(ka_mono_superpos2)]))
# ka-Anzeige anlegen
ka_mono_superpos1_button_label = Paragraph(text=r"$$\mu_1$$= " + str(np.round(ka_mono_superpos1, decimals=2)), styles={'font-style': 'italic', 'font-size': '16px'})
ka_mono_superpos2_button_label = Paragraph(text=r"$$\mu_2$$= " + str(np.round(ka_mono_superpos2, decimals=2)), styles={'font-style': 'italic', 'font-size': '16px'})
...
def mono_superpos1_ka_plus_button_callback():
    ...
    ka_mono_superpos1_button_label.text = r"$$\mu_1$$= " + str(np.round(ka_mono_superpos1, decimals=2))
...
def mono_superpos2_ka_plus_button_callback():
    ...
    ka_mono_superpos2_button_label.text = r"$$\mu_2$$= " + str(np.round(ka_mono_superpos2, decimals=2))
    update_plot()       # ka-Punkte aktualisieren
    reset_time()
...
def di_ka_plus_button_callback():
    ...
    if ka_di + 2*np.pi/unitcell_number <= 3.1:
        ...
        ka_di = np.pi
    ka_di_button_label.text = r"$$\mu$$= " + str(np.round(ka_di, decimals=2))
    update_plot()
    reset_time()
...
fig_dispersion_di.xaxis.axis_label = r"$$\mu$$"
...
ka_di_acou_superpos1_button_label = \
    Paragraph(text=r"$$\mu_1$$= " + str(np.round(ka_di_acou_superpos1, decimals=2)), styles={'font-style': 'italic', 'font-size': '16px'})
ka_di_acou_superpos2_button_label = \
    Paragraph(text=r"$$\mu_2$$= " + str(np.round(ka_di_acou_superpos2, decimals=2)), styles={'font-style': 'italic', 'font-size': '16px'})
...
def di_acou_superpos1_ka_plus_button_callback():
    ...
    ka_di_acou_superpos1_button_label.text = r"$$\mu_1$$= " + str(np.round(ka_di_acou_superpos1, decimals=2))
    update_plot()
    reset_time()
...
def di_acou_superpos2_ka_plus_button_callback():
    ...
    ka_di_acou_superpos2_button_label.text = r"$$\mu_2$$= " + str(np.round(ka_di_acou_superpos2, decimals=2))
    update_plot()
    reset_time()
...
ka_di_opti_superpos1_button_label = \
    Paragraph(text=r"$$\mu_1$$= " + str(np.round(ka_di_opti_superpos1, decimals=2)), styles={'font-style': 'italic', 'font-size': '16px'})
ka_di_opti_superpos2_button_label = \
    Paragraph(text=r"$$\mu_2$$= " + str(np.round(ka_di_opti_superpos2, decimals=2)), styles={'font-style': 'italic', 'font-size': '16px'})
...
def di_opti_superpos1_ka_plus_button_callback():
    ...
    ka_di_opti_superpos1_button_label.text = r"$$\mu_1$$= " + str(np.round(ka_di_opti_superpos1, decimals=2))
    update_plot()
    reset_time()
...
def di_opti_superpos2_ka_plus_button_callback():
    ...
    ka_di_opti_superpos2_button_label.text = r"$$\mu_2$$= " + str(np.round(ka_di_opti_superpos2, decimals=2))
    update_plot()
    reset_time()
...
def change_content():
    ...
    if language == 'deutsch':
        ...
        with open(r"Dispersion1DMassSpringChain\static\Html\monoatomic\deutsch\mono_beschreibung.html", 'r') as file:
            mono_html_content1 = file.read()
        with open(r"Dispersion1DMassSpringChain\static\Html\monoatomic\deutsch\ÜberschriftIntro.html", 'r') as file:
            mono_html_content11 = file.read()
        with open(r"Dispersion1DMassSpringChain\static\Html\monoatomic\deutsch\monoatomareAnimationsbeschreibung.html", 'r') as file:
            mono_html_content2 = file.read()
        with open(r"Dispersion1DMassSpringChain\static\Html\monoatomic\deutsch\superposition_beschreibung.html", 'r') as file:
            mono_html_content3 = file.read()
        with open(r'Dispersion1DMassSpringChain\static\Html\monoatomic\deutsch\superposition_erklärung.html', 'r') as file:
            mono_html_content4 = file.read()
        # Diatomare HTMLs
        with open(r"Dispersion1DMassSpringChain\static\Html\diatomic\deutsch\diatomar_beschreibung.html", 'r') as file:
            di_html_content1 = file.read()
        with open(r"Dispersion1DMassSpringChain\static\Html\diatomic\deutsch\diatomareAnimationbeschreibung.html", 'r') as file:
            di_html_content2 = file.read()
        with open(r"Dispersion1DMassSpringChain\static\Html\diatomic\deutsch\di_superposition_beschreibung.html", 'r') as file:
            di_html_content3 = file.read()
        with open(r'Dispersion1DMassSpringChain\static\Html\diatomic\deutsch\di_superposition_acou_erklärung.html', 'r') as file:
            di_html_content4 = file.read()
        with open(r'Dispersion1DMassSpringChain\static\Html\diatomic\deutsch\di_superposition_opti_erklärung.html', 'r') as file:
            di_html_content5 = file.read()
        with open(r"Dispersion1DMassSpringChain\static\Html\diatomic\deutsch\ÜberschriftIntro.html", 'r') as file:
            di_html_content11 = file.read()

    elif language == 'english':
        # Monoatomic HTMLs
        with open(r"Dispersion1DMassSpringChain\static\Html\monoatomic\english\mono_beschreibung.html", 'r') as file:
            mono_html_content1 = file.read()
        with open(r"Dispersion1DMassSpringChain\static\Html\monoatomic\english\ÜberschriftIntro.html", 'r') as file:
            mono_html_content11 = file.read()
        with open(r"Dispersion1DMassSpringChain\static\Html\monoatomic\english\monoatomareAnimationsbeschreibung.html", 'r') as file:
            mono_html_content2 = file.read()
        with open(r"Dispersion1DMassSpringChain\static\Html\monoatomic\english\superposition_beschreibung.html", 'r') as file:
            mono_html_content3 = file.read()
        with open(r'Dispersion1DMassSpringChain\static\Html\monoatomic\english\superposition_erklärung.html', 'r') as file:
            mono_html_content4 = file.read()
        # Diatomic HTMLs
        with open(r"Dispersion1DMassSpringChain\static\Html\diatomic\english\diatomar_beschreibung.html", 'r') as file:
            di_html_content1 = file.read()
        with open(r"Dispersion1DMassSpringChain\static\Html\diatomic\english\diatomareAnimationbeschreibung.html", 'r') as file:
            di_html_content2 = file.read()
        with open(r"Dispersion1DMassSpringChain\static\Html\diatomic\english\di_superposition_beschreibung.html", 'r') as file:
            di_html_content3 = file.read()
        with open(r'Dispersion1DMassSpringChain\static\Html\diatomic\english\di_superposition_acou_erklärung.html', 'r') as file:
            di_html_content4 = file.read()
        with open(r'Dispersion1DMassSpringChain\static\Html\diatomic\english\di_superposition_opti_erklärung.html', 'r') as file:
            di_html_content5 = file.read()
        with open(r"Dispersion1DMassSpringChain\static\Html\diatomic\english\ÜberschriftIntro.html", 'r') as file:
            di_html_content11 = file.read()
...
mono_block1 = column(general_app_infos, column(row(Spacer(width=85), monoatomicPNG), mono_unitcellPNG), general_monoatomic_infos)
