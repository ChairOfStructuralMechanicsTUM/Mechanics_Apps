...
strings  = strings  = yaml.safe_load(open(app_base_path / 'static' / 'strings.json', encoding='utf-8'))
...
boat_and_swimmers_filename = str(app_base_path / "boat_and_swimmers.html")
boat_and_swimmers = Div(text=open(boat_and_swimmers_filename).read(), render_as_text=False, width=400)
