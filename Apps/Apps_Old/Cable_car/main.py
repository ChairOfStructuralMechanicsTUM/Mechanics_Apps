...
description_filename1 = str(app_base_path / "description1.html") #Part I of the description
description1 = LatexDiv(text=open(description_filename1).read(), render_as_text=False, width=1000)

description_filename2 = str(app_base_path / "description2.html") #Part II of the description
description2 = LatexDiv(text=open(description_filename2).read(), render_as_text=False, width=1000)

description_filename3 = str(app_base_path / "description3.html") #Part III of the description
description3 = LatexDiv(text=open(description_filename3).read(), render_as_text=False, width=1000)

#Figures_static
# Plot
#Kinematics of the cable car 
kinematics_img= str(app_base_path.relative_to(app_base_path.parent) / "static" / "Kinematics.svg")
...
fbd_img=str(app_base_path.relative_to(app_base_path.parent) / "static" / "Free_Body_Diagram.svg")
...
# Support source
support_source_bottom = ColumnDataSource(dict(x = [0], y = [0+10.0] , src = [str(app_base_path.relative_to(app_base_path.parent) / "static" / "fixed_support.svg")]))
support_source_top    = ColumnDataSource(dict(x = [B], y = [H+5.0] , src = [str(app_base_path.relative_to(app_base_path.parent) / "static" / "fixed_support.svg")]))
...
#blublub1=split(dirname(__file__))[-1].replace('_',' ').replace('-',' ')
#blublub2=str(app_base_path.relative_to(app_base_path.parent)).replace("_"," ").replace("-"," ")
#print(blublub1)
#print(blublub2)
