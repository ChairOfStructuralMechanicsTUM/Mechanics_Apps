...
export interface TA_Surface3d extends TA_Surface3d.Attrs {}

export class TA_Surface3d extends LayoutDOM {
  properties: TA_Surface3d.Props
  __view_type__: Surface3dView

  constructor(attrs?: Partial<TA_Surface3d.Attrs>) {
    super(attrs)
  }
  ...
  static __name__ = "TA_Surface3d"

  static init_TA_Surface3d() {
    ...
    this.define<TA_Surface3d.Props>({
      x:            [ p.String   ],
      y:            [ p.String   ],
      z:            [ p.String   ],
