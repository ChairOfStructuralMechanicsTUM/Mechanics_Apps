...
snow_images = [str(app_base_path.relative_to(app_base_path.parent)/"static"/"images"/"snowflake01.svg"),
               str(app_base_path.relative_to(app_base_path.parent)/"static"/"images"/"snowflake02.svg"),
               str(app_base_path.relative_to(app_base_path.parent)/"static"/"images"/"snowflake03.svg")]
...
fire_images = [str(app_base_path.relative_to(app_base_path.parent)/"static"/"images"/"fire01.svg"),
               str(app_base_path.relative_to(app_base_path.parent)/"static"/"images"/"fire02.svg"),
               str(app_base_path.relative_to(app_base_path.parent)/"static"/"images"/"fire03.svg")]
