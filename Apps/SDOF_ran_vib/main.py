...
print('t:', len(t_list),'f:', len(f_list))
print(len(t_list))
...
def update_impulse(attrname, old, new):
    ...
    print('H:', len(H_x),'n_abs(H)', len(np.abs(H_x)))
...
def update_excitation_cov(attrname, old, new):
    ...
    print('x=', len(x), 'y1=', len(y1),'y2=', len(y2))

    ds_excitation_time_varea.data["x"] = x
    ds_excitation_time_varea.data["y1"] = y1
    ds_excitation_time_varea.data["y2"] = y2
    print('ds_excitation_time_varea.data=y2', len(ds_excitation_time_varea.data))
