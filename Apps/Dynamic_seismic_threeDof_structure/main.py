...
signalOne   = read_seismic_input(file=app_base_path /'Time_domain_signals/San_Ramon_Fire_Station/RSN215_LIVERMOR_A-SRM070.AT2', scale = initial_scale_value1
)
signalTwo   = read_seismic_input(file=app_base_path /'Time_domain_signals/Rio_Hondo/RSN8837_14383980_CIRIOHNE1.AT2', scale = initial_scale_value2
)
signalThree = read_seismic_input(file=app_base_path /'Time_domain_signals/Bevagna/RSN4346_UBMARCHE.P_A-BEV000.AT2', scale = initial_scale_value3)
signalFour = read_seismic_input(file=app_base_path /'Time_domain_signals/Kobe_new/RSN1106_KOBE_KJM000.AT2', scale = initial_scale_value4)
...
###############################################################################
'''
ERS_dataOne = read_ERS_data(file=app_base_path /'Time_domain_signals/San_Ramon_Fire_Station/_SearchResults.csv')
ERS_dataTwo = read_ERS_data(file=app_base_path /'Time_domain_signals/Rio_Hondo/_SearchResults.csv')
ERS_dataThree = read_ERS_data(file=app_base_path /'Time_domain_signals/Bevagna/_SearchResults.csv')
ERS_dataFour = read_KOKE_ERS_data(file=app_base_path /'Time_domain_signals/Kobe_new/_SearchResults.csv')
...
ERS_dataOne_info = Read_ERS_info(file= app_base_path /'Time_domain_signals/San_Ramon_Fire_Station/_SearchResults.csv')
ERS_dataTwo_info = Read_ERS_info(file=app_base_path /'Time_domain_signals/Rio_Hondo/_SearchResults.csv')
ERS_dataThree_info = Read_ERS_info(file=app_base_path /'Time_domain_signals/Bevagna/_SearchResults.csv')
ERS_dataFour_info = Read_Kobe_ERS_info(file=app_base_path /'Time_domain_signals/Kobe_new/_SearchResults.csv')
